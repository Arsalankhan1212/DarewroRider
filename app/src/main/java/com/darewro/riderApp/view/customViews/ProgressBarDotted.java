...
public class ProgressBarDotted extends View {
    ...
    private Runnable mRunnable = new Runnable() {
        ...
        public void run() {
            ...
            ProgressBarDotted.this.invalidate();
            mHandler.postDelayed(mRunnable, mJumpingSpeed);
        }
    };


    public ProgressBarDotted(Context context, AttributeSet attrs) {
        super(context, attrs);

        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.ProgressBarDotted,
                0, 0);
...
//            mActiveDotColor = a.getColor(R.styleable.DottedProgressBar_activeDotColor, Color.BLUE);
            ...
            a.getValue(R.styleable.ProgressBarDotted_activeDot, value);
            ...
            a.getValue(R.styleable.ProgressBarDotted_inactiveDot, value);
            if (value.type >= TypedValue.TYPE_FIRST_COLOR_INT && value.type <= TypedValue.TYPE_LAST_COLOR_INT) {
                // It's a color
            ...
            mDotSize = a.getDimensionPixelSize(R.styleable.ProgressBarDotted_dotSize, 5);
            mSpacing = a.getDimensionPixelSize(R.styleable.ProgressBarDotted_spacing, 10);

            mActiveDotIndex = a.getInteger(R.styleable.ProgressBarDotted_activeDotIndex, 0);

            mJumpingSpeed = a.getInt(R.styleable.ProgressBarDotted_jumpingSpeed, 500);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mNumberOfDots = 4;//calculateDotsNumber(widthWithoutPadding);
    }
