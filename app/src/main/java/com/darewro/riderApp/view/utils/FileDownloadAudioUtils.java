...
public class FileDownloadAudioUtils extends AsyncTask<Void, Integer, Boolean> {
    ...
    public FileDownloadAudioUtils(Context context, String url, String fileName, String messageId, ProgressBar progressBar, VoicePlayerView voicePlayerView, ImageButton resend) {
