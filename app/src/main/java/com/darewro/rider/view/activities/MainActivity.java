...
import com.darewro.rider.data.api.handlers.NearestOrdersHandler;
...
import com.darewro.rider.presenter.ResponseListenerAllOrdersListing;
import com.darewro.rider.presenter.ResponseListenerNearestOrdersListing;
...
import com.darewro.rider.view.adapters.OrderFragmentViewPagerAdapter;
...
import com.darewro.rider.view.xmpp.LocalBinder;
...
//    }
    ...
    public void onResume() {
        ...
        //when active order list is fetched i.e getOrders() then fetched getAllOrders()
        //getAllOrders();
...
//        populateData();
    ...
    public void onSuccess(List<AllOrder> allOrders, String calledApi) {
        ...
        runOnUiThread(() -> adapter.getItem(2).setData(true, allOrders));
    }


    @Override
    public void onSuccess(String calledApi, final List<Order> orders, final List<Order> completedOrders) {
        //when active order list is fetched, then get all order list b/c we've to check if any active order is running
        getAllOrders();
    ...
    public void onSuccess(String calledApi, final List<NearestOrder> orders, boolean nearest) {
        runOnUiThread(() -> adapter.getItem(2).setData(orders, true));
    }
